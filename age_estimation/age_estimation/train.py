...
def parse_args():
    ...
    parser.add_argument('--dist_weight', help='Distance weight', type=float, default=0.0)
    parser.add_argument('--const_weight', help='Constant weight', type=float, default=0.0)
    parser.add_argument('--reqgrad', help='Constant weight', type=float, default=0.0)
    parser.add_argument('--label', help='identifying label', type=str)
    parser.add_argument('--init', help='identifying label', type=str)
    parser.add_argument('--initrand', help='code or rand', type=str)
    ...
    parser.add_argument('--version',default="V1" ,help='loss in BCE, CE, MAE', type=str)
...
if __name__ == '__main__':
    ...
    if args.transform == 'cnt':
        ...
        transform = FileTransform(CODINGS_HOME + "belu_" + str(val_range) + "_tensor.pkl")  
    elif args.transform == 'lrn':
        transform = LearnableTransform(val_range, val_range,args.initrand,pickle.load(open(CODINGS_HOME + "bel"+str(args.init)+"_" + str(val_range) + "_tensor.pkl","rb")))
    bits = transform.bits
    ...
    elif args.reverse_transform == 'lrn':
