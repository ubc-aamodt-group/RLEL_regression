...
def test(cfg, args, name):
    ...
    model = build_model(cfg, bits,init=args.init)
    ...
    # build the optimizer
    optimizer = make_optimizer(cfg, model,reqgrad=args.reqgrad)
...
def main():
    ...
    parser.add_argument('--init', help='loss in BCE, CE, MAE', type=str)
    parser.add_argument('--version', help='loss in BCE, CE, MAE',default="V1" ,type=str)
    parser.add_argument('--reqgrad', help='Os decoding matrix trained',default=0.0, type=float)
    parser.add_argument('--dist_weight', help='loss in BCE, CE, MAE',default=0.0, type=float)
    parser.add_argument('--const_weight', help='loss in BCE, CE, MAE',default=0.0, type=float)
    parser.add_argument(
        "opts",
