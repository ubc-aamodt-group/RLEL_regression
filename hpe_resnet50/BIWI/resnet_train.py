...
if __name__ == '__main__':
    ...
    helper.train(model,train_loader, test_loader, pose_dataset, args.output_string, gpu, args.arch,args.lr,50,batch_size,195,args.num_bits,args.code_bits,args.code,loss_func,di,dis,args,args.reqgrad)
