...
def main():
    ...
    if config.DATASET.DATASET=="WFLW":
        print("blur")
        nme, predictions,_ = function.validate(config, blur_loader, model, criterion, epoch, writer_dict, loss_function,str(final_output_dir),actual_code)
        print("expression")
        nme, predictions,_ = function.validate(config, expression_loader, model, criterion, epoch, writer_dict, loss_function,str(final_output_dir),actual_code)
        print("ill")
        nme, predictions,_ = function.validate(config, ill_loader, model, criterion, epoch, writer_dict, loss_function,str(final_output_dir),actual_code)
        print("large")
        nme, predictions,_ = function.validate(config, large_loader, model, criterion, epoch, writer_dict, loss_function,str(final_output_dir),actual_code)
        print("make")
        nme, predictions,_ = function.validate(config, make_loader, model, criterion, epoch, writer_dict, loss_function,str(final_output_dir),actual_code)
        print("occ")
        nme, predictions,_ = function.validate(config, occ_loader, model, criterion, epoch, writer_dict, loss_function,str(final_output_dir),actual_code)
    elif config.DATASET.DATASET=="AFLW":
        nme, predictions,_ = function.validate(config, front_loader, model, criterion, epoch, writer_dict, loss_function,str(final_output_dir),actual_code)
    elif config.DATASET.DATASET=="300W":
        print("Test")
        nme, predictions,_ = function.validate(config, test_loader, model, criterion, epoch, writer_dict, loss_function,str(final_output_dir),actual_code)
        print("common")
        nme, predictions,_ = function.validate(config, common_loader, model, criterion, epoch, writer_dict, loss_function,str(final_output_dir),actual_code)
        print("challenge")
        nme, predictions,_ = function.validate(config, challenge_loader, model, criterion, epoch, writer_dict, loss_function,str(final_output_dir),actual_code)
    nme, predictions,_ = function.validate(config, val_loader, model, criterion, epoch, writer_dict, loss_function,str(final_output_dir),actual_code)
